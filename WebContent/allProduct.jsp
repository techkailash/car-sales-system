...
<div class="container-wrapper">
		...
		<th><b>Product Prize</b></th>
       <th><b>Launch Date</b></th>
		<th><b>image Location</b></th>
	...
	%>
			...
			<td><%=resultSet.getString("imagelocation") %></td>
...
%>
               ...
               <center><a href="adminloginsuccess.jsp" class="btn btn-success">Go To admin page</a></center> 
            </div>
        </section>
        </div>
